      ...
      <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
        <div class="flex items-center space-x-3">
          <NuxtLink to="/" class="flex items-center">
            <span class="font-bold text-xl text-gray-800 dark:text-dark-text">LN2UPI</span>
            <span class="text-xs bg-blue-100 dark:bg-lightning-blue/20 text-lightning-blue dark:text-lightning-blue px-2 py-0.5 rounded-full border border-blue-200 dark:border-lightning-blue/30 ml-2">Beta</span>
          </NuxtLink>
        </div>
        ...
        <div class="hidden md:flex items-center space-x-1">
          ...
          <div class="ml-2 border-l border-gray-200 dark:border-dark-border pl-2">
            ...
            <button 
              ...
              class="inline-flex items-center px-2 py-1 rounded text-sm font-medium hover:bg-gray-100 dark:hover:bg-dark-border transition-colors"
        ...
        <div class="flex md:hidden space-x-2 items-center">
          <NuxtLink to="/send" class="px-3 py-1.5 rounded-md bg-lightning-blue text-white text-sm font-medium">
            Send
          </NuxtLink>
          <NuxtLink to="/receive" class="px-3 py-1.5 rounded-md bg-upi-green text-white text-sm font-medium">
            Receive
          </NuxtLink>
          <button 
            @click="toggleDarkMode" 
            class="p-1.5 rounded-full text-sm ml-2 bg-gray-100 dark:bg-dark-border"
          >
      ...
      <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row justify-between pb-6 border-b border-gray-200 dark:border-dark-border">
          <div class="mb-6 md:mb-0">
            <h2 class="font-bold text-lg text-gray-800 dark:text-dark-text mb-3">LN2UPI</h2>
